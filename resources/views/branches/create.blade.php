            ...
            <div class="flex items-center space-x-4 mb-4">
                ...
                <div class="flex-1">
                    <nav class="flex items-center space-x-2 text-sm text-gray-500 mb-2">
                        ...
                        <span class="text-gray-900 font-medium">Add Branch</span>
                    </nav>
                    <h1 class="text-3xl font-bold text-gray-900">Add New Branch</h1>
                    <p class="text-gray-600 mt-1">Create a new branch or office for your organization</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input type="text" name="code" readonly
                                       class="w-full h-10 px-3 text-sm border border-gray-300 rounded-lg bg-gray-50 text-gray-500 cursor-not-allowed focus:outline-none"
                                       placeholder="Will be auto-generated (e.g., BR01, BR02)"
                                       value="{{ old('code') }}">
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="type" required
                                ...
                                <option value="Head Office" {{ old('type', 'Head Office') == 'Head Office' ? 'selected' : '' }}>Head Office</option>
                                ...
                                <option value="Sales Office" {{ old('type') == 'Sales Office' ? 'selected' : '' }}>Sales Office</option>
                            </select>
                            @error('type')
                                <p class="text-xs text-red-600 flex items-center mt-1">
                                    <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <textarea name="address" required rows="3"
                                      ...
                                      placeholder="Complete address of the branch">{{ old('address', '123 Main Street, Business District') }}</textarea>
                            @error('address')
                                <p class="text-xs text-red-600 flex items-center mt-1">
                                    <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="province" required
                                   ...
                                   value="{{ old('province', 'Metro Manila') }}">
                            @error('province')
                                <p class="text-xs text-red-600 flex items-center mt-1">
                                    <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="country" required
                                   class="w-full h-10 px-3 text-sm border border-gray-300 rounded-lg bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors"
                                   placeholder="Country"
                                   value="{{ old('country', 'PH') }}" maxlength="3">
                            @error('country')
                                <p class="text-xs text-red-600 flex items-center mt-1">
                                    <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="timezone"
                                   ...
                                   value="{{ old('timezone', 'Asia/Manila') }}">
                        </div>
                    </div>
                </div>
            </div>
