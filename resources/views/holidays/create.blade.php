            ...
            <div class="flex items-center space-x-4 mb-4">
                ...
                <div class="flex-1">
                    <nav class="flex items-center space-x-2 text-sm text-gray-500 mb-2">
                        ...
                        <span class="text-gray-900 font-medium">Add Holiday</span>
                    </nav>
                    <h1 class="text-3xl font-bold text-gray-900">Add New Holiday</h1>
                    <p class="text-gray-600 mt-1">Create a new holiday for your organization</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="type" required
                                ...
                                <option value="Special Non-Working" {{ old('type') == 'Special Non-Working' ? 'selected' : '' }}>Special Non-Working</option>
                                <option value="Special Working" {{ old('type') == 'Special Working' ? 'selected' : '' }}>Special Working</option>
                            </select>
                            @error('type')
                                <p class="text-xs text-red-600 flex items-center mt-1">
                                    <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="scope" required
                                ...
                                <option value="Company" {{ old('scope') == 'Company' ? 'selected' : '' }}>Company</option>
                            </select>
                            @error('scope')
                                <p class="text-xs text-red-600 flex items-center mt-1">
                                    <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <textarea name="description" rows="3"
                                      ...
                                      placeholder="Holiday description (optional)">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="text-xs text-red-600 flex items-center mt-1">
                                    <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                <input type="text" name="applicable_branches[]"
                                       ...
                                       value="{{ old('applicable_branches.0') }}">
                                <input type="text" name="applicable_branches[]"
                                       class="w-full h-10 px-3 text-sm border border-gray-300 rounded-lg bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors"
                                       placeholder="Branch name (optional)"
                                       value="{{ old('applicable_branches.1') }}">
                            </div>
