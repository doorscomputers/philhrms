            ...
            <div class="flex items-center space-x-4 mb-4">
                ...
                <div class="flex-1">
                    <nav class="flex items-center space-x-2 text-sm text-gray-500 mb-2">
                        ...
                        <span class="text-gray-900 font-medium">Edit {{ $department->name }}</span>
                    </nav>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2 space-y-2">
                            ...
                            <textarea name="description" rows="3"
                                      ...
                                      placeholder="Department description (optional)">{{ old('description', $department->description) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="cost_center_code"
                                   ...
                                   value="{{ old('cost_center_code', $department->cost_center_code) }}">
                        </div>
                            ...
                            <div class="flex space-x-4">
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="is_active" value="0"
                                           {{ old('is_active', $department->is_active) == '0' ? 'checked' : '' }}
                                           class="w-4 h-4 text-emerald-600 border-gray-300 focus:ring-emerald-500">
