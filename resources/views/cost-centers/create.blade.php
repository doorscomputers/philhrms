...
<div class="min-h-screen bg-gray-50/30">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <h1 class="text-3xl font-bold text-gray-900">Create Cost Center</h1>
                        <p class="text-gray-600 mt-1">Set up a new cost center for budget and expense tracking</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-4xl mx-auto px-6 pb-12">
        <form action="{{ route('cost-centers.store') }}" method="POST" class="space-y-8">
            @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            @error('code')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">Leave empty to auto-generate (CC001, CC002, etc.)</p>
                        </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
                <div class="px-6 py-4 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Set budget allocation and period for this cost center</p>
                </div>
                <div class="p-6">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
                ...
                <div class="p-6">
                    ...
                    <textarea id="description"
                              ...
                              placeholder="Enter cost center description">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
